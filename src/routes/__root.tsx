...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "PawVerse — AI-powered cat & dog adoption and foster" },
      { property: "og:description", content: "PawVerse makes finding a foster or forever cat or dog hassle-free, with an AI counselor that matches you to the right pet and guides your adoption end to end." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "PawVerse — AI-powered cat & dog adoption and foster" },
      { name: "twitter:description", content: "PawVerse makes finding a foster or forever cat or dog hassle-free, with an AI counselor that matches you to the right pet and guides your adoption end to end." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/v0gFHgGRjteUpaCdCiMAoweK1SL2/social-images/social-1782585801292-cutecat.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/v0gFHgGRjteUpaCdCiMAoweK1SL2/social-images/social-1782585801292-cutecat.webp" },
    ],
    links: [

...
export const Route = createFileRoute("/foster")({
  head: () => ({
    meta: [
      { title: "Foster a cat or dog — PawVerse" },
      { name: "description", content: "Open your home temporarily. Fostering saves lives and helps pets decompress before adoption." },
    ],
  }),
  component: Foster,
});
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-5xl px-4 py-12">
        <div className="glass-card overflow-hidden rounded-[2rem] md:grid md:grid-cols-2">
          <img src="https://images.unsplash.com/photo-1583337130417-3346a1be7dee?w=900" alt="A foster pet in a warm sunbeam" className="h-72 w-full object-cover md:h-full" />
          <div className="p-8 md:p-12">
            <h1 className="text-4xl font-bold md:text-5xl">Foster a pet 🏡</h1>
            <p className="mt-3 text-muted-foreground">Fostering is the kindest first step. You give a cat or dog a safe space to decompress, while we cover food and vet care.</p>
